...
auth.verifyOtp = async (req, res) => {
  try {
    ...
    console.log('Stored OTP:', user.otp); // Log the stored OTP
    console.log('Type of stored OTP:', typeof user.otp); // Log the type of stored OTP

    // Convert to string and compare OTPs
